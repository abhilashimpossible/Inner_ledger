...
const CACHE = "thoughtpattern-v12";
const SHELL = ["./", "index.html", "manifest.webmanifest", "icon-192.png", "icon-512.png", "apple-touch-icon.png", "icon-maskable-192.png", "icon-maskable-512.png", "favicon.ico", "favicon.svg"];
